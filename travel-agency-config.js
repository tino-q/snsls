...
export const TRAVEL_AGENCY_CONFIG = {
  // Company Information
  company: {
...
// Helper function to update HTML content with config values
export function updateHTMLWithConfig() {
  // This function can be used to dynamically replace content in HTML
  // Example usage in JavaScript to replace placeholders
}
