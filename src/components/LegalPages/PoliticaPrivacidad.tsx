  ...
  return (
    <div className="legal-page">
      <div className="legal-container">
        ...
        <p>
          Sonsoles Rkt, SL, en aplicación de la normativa vigente en materia de
          ...
          https://travel.sonsolesstays.com, se incluyen en los ficheros
          automatizados específicos de usuarios de los servicios de Sonsoles
          Rkt, SL
        </p>
        ...
        <p>
          ...
          asesoramiento y otras actividades propias de Sonsoles Rkt, SL
        </p>
        ...
        <p>
          Sonsoles Rkt, SL adopta las medidas necesarias para garantizar la
        ...
        <p>
          ...
          portabilidad reconocidos en el citado Reglamento (UE). El ejercicio de
          estos derechos puede realizarlo el propio usuario a través de email a:
          madelainebaklayan@gmail.com o en la dirección: C/ Bernardo Lopez
          Garcia 18, Bajo , C.P. 03013 - Alicante (Alicante).
        </p>
        ...
        <p>
          ...
          comunicando los cambios a Sonsoles Rkt, SL
        </p>
        ...
        <p>
          En Sonsoles Rkt, SL, trataremos tus datos personales recabados a
          través del Sitio Web: https://travel.sonsolesstays.com, con las
          siguientes finalidades:
        </p>

        <ol>
          <li>
            Dar cumplimiento de las obligaciones, comerciales, laborales,
            corporativas y contables de la empresa.
          </li>
          <li>
            La transmisión de datos a terceros con los cuales se hayan celebrado
            contratos con este objeto, para fines comerciales, contractuales,
          ...
          <li>
            Facilitar la información solicitada por el usuario a través del
        ...
        <ol>
          <li>
            La solicitud de información y/o la contratación de los servicios de
            Sonsoles Rkt, SL, cuyos términos y condiciones se pondrán a tu
            disposición en todo caso, de forma previa a una eventual
            contratación.
          </li>
          <li>
            El consentimiento libre, específico, informado e inequívoco, en
            tanto que te informamos poniendo a tu disposición la presente
            política de privacidad, que tras la lectura de la misma, en caso de
            estar conforme, puedes aceptar mediante una declaración o una clara
            acción afirmativa, como el marcado de una casilla dispuesta al
            efecto.
          </li>
        </ol>
        ...
        <p>
          Los datos no se comunicarán a ningún tercero ajeno a Sonsoles Rkt, SL,
        ...
        <p>
          ...
          personal en los servidores de alojamiento compartido, Sonsoles Rkt, SL
          no se hace responsable del incumplimiento por parte del usuario del
          RGPD.
        </p>

        <h2>Derechos propiedad intelectual https://travel.sonsolesstays.com</h2>

        <p>
          Sonsoles Rkt, SL es titular de todos los derechos de autor, propiedad
          intelectual, industrial, "know how" y cuantos otros derechos guardan
          relación con los contenidos del sitio web
          https://travel.sonsolesstays.com y los servicios ofertados en el
          mismo, así como de los programas necesarios para su implementación y
        ...
        <p>
          ...
          https://travel.sonsolesstays.com sin el consentimiento previo y por
          escrito.
        </p>
        ...
        <p>
          ...
          disposición por Sonsoles Rkt, SL, aún siendo gratuitos y/o de
          disposición pública.
        </p>

        <p>
          Sonsoles Rkt, SL dispone de los derechos de explotación y propiedad
        ...
        <p>
          ...
          usuario necesitará autorización por escrito por parte de Sonsoles Rkt,
          SL, quedando prohibido al usuario acceder, modificar, visualizar la
          configuración, estructura y ficheros de los servidores propiedad de
          Sonsoles Rkt, SL, asumiendo la responsabilidad civil y penal derivada
        ...
        <p>
          ...
          intelectual de los servicios prestados por Sonsoles Rkt, SL y, en
          particular de:
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            de Sonsoles Rkt, SL, resulte violento, obsceno, abusivo, ilegal,
        ...
        <p>
          El usuario indemnizará a Sonsoles Rkt, SL por los gastos que generara
          la imputación de Sonsoles Rkt, SL en alguna causa cuya responsabilidad
        ...
        <p>
          Sonsoles Rkt, SL realiza copias de seguridad de los contenidos
        ...
        <p>
          ...
          de seguridad realizadas por Sonsoles Rkt, SL, cuando esta pérdida sea
          imputable al usuario; en este caso, se determinará una tarifa acorde a
          la complejidad y volumen de la recuperación, siempre previa aceptación
          del usuario.
        </p>
        ...
        <p>
          ...
          atribuibles a Sonsoles Rkt, SL.
        </p>

        <h2>Comunicaciones comerciales</h2>

        <p>
          En aplicación de la LSSI. Sonsoles Rkt, SL no enviará comunicaciones
        ...
        <p>
          ...
          previa, Sonsoles Rkt, SL sí está autorizado al envío de comunicaciones
          comerciales referentes a productos o servicios de Sonsoles Rkt, SL que
