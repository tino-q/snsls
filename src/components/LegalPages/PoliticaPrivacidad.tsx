    ...
    <>
      ...
      <div className="legal-page">
        <div className="legal-container">
          ...
          <p>
            Sonsoles Rkt, SL, en aplicación de la normativa vigente en materia
          ...
          <p>
            ...
            email a: madelainebaklayan@gmail.com o en la dirección: C/ Bernardo
            Lopez Garcia 18, Bajo , C.P. 03013 - Alicante (Alicante).
          </p>
          ...
          <ol>
            ...
            <li>
              La transmisión de datos a terceros con los cuales se hayan
              celebrado contratos con este objeto, para fines comerciales,
              contractuales, administrativos, de mercadeo y/o operativos.
            </li>
          ...
          <ol>
            <li>
              ...
              de Sonsoles Rkt, SL, cuyos términos y condiciones se pondrán a tu
          ...
          <p>
            ...
            del todo imposible proporcionarte la información solicitada o llevar
            a cabo la contratación de los servicios.
          </p>

          <h2>Destinatarios:</h2>

          <p>
            Los datos no se comunicarán a ningún tercero ajeno a Sonsoles Rkt,
            SL, salvo obligación legal.
          </p>
          ...
          <p>
            ...
            Sonsoles Rkt, SL no se hace responsable del incumplimiento por parte
            del usuario del RGPD.
          </p>

          <h2>
            Derechos propiedad intelectual https://travel.sonsolesstays.com
          </h2>

          <p>
            Sonsoles Rkt, SL es titular de todos los derechos de autor,
          ...
          <p>
            ...
            servicio, excepción hecha de los derechos y licencias necesarios
            para el cumplimiento de los servicios contratados y únicamente
            durante la duración de los mismos.
          </p>

          <p>
            Para toda actuación que exceda del cumplimiento del contrato, el
            usuario necesitará autorización por escrito por parte de Sonsoles
            Rkt, SL, quedando prohibido al usuario acceder, modificar,
            visualizar la configuración, estructura y ficheros de los servidores
            propiedad de Sonsoles Rkt, SL, asumiendo la responsabilidad civil y
            penal derivada de cualquier incidencia que se pudiera producir en
          ...
          <ul>
            ...
            <li>
              ...
              juicio de Sonsoles Rkt, SL, resulte violento, obsceno, abusivo,
          ...
          <p>
            El usuario indemnizará a Sonsoles Rkt, SL por los gastos que
            generara la imputación de Sonsoles Rkt, SL en alguna causa cuya
          ...
          <p>
            ...
            las copias de seguridad realizadas por Sonsoles Rkt, SL, cuando esta
          ...
          <p>
            ...
            sido solicitadas o expresamente autorizadas por los destinatarios de
            las mismas.
          </p>

          <p>
            En el caso de usuarios con los que exista una relación contractual
            previa, Sonsoles Rkt, SL sí está autorizado al envío de
            comunicaciones comerciales referentes a productos o servicios de
            Sonsoles Rkt, SL que sean similares a los que inicialmente fueron
