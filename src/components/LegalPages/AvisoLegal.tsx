    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <p>
          ...
          Información y del Comercio Electrónico (LSSICE), el propietario de la
          web https://travel.sonsolesstays.com, le informa de lo siguiente:
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Inscrita en el Registro Mercantil de MADRID</strong> al Tomo
            43813, folio 60, sección 8, hoja número 773190, inscripción 1
          </li>
        </ul>
        ...
        <p>
          ...
          https://travel.sonsolesstays.com ni constituyen opiniones, consejos o
        ...
        <p>
          ...
          https://travel.sonsolesstays.com no puede asumir responsabilidades por
        ...
        <p>
          ...
          https://travel.sonsolesstays.com o sus licenciantes. Cualquier acto de
        ...
        <p>
          ...
          y a la libre circulación de estos datos le informamos que, mediante la
          cumplimentación de los presentes formularios, sus datos personales
          quedarán incorporados y serán tratados en los ficheros de Sonsoles
          Rkt, SL con el fin de poderle prestar y ofrecer nuestros servicios así
          ...
          personal, manera gratuita mediante email a madelainebaklayan@gmail.com
          o en la dirección C/ Bernardo Lopez Garcia 18, Bajo , 03013 - Alicante
          (Alicante).
        </p>
      </div>
    </div>
